...
import { productDetail ,titleProductDetail } from "./components/sections.js";
...
addEventListener("DOMContentLoaded", async(e)=>{
    ...
    main__section__price.innerHTML = await buttonCartDetails(info) 
...
const quantity = async (e)=>{
    ...
    if(res.product_original_price) amount = product_original_price = Number(res.product_original_price.replace("$", ""));
